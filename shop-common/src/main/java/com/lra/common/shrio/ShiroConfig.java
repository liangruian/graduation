...
public class ShiroConfig {
    ...
    @Value("${shrioRedis.host}")
    private String shrioRedisHost;

    @Value("${shrioRedis.port}")
    private Integer redisPort;

    @Value("${shrioRedis.timeout}")
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 没有登陆的用户只能访问登陆页面
        shiroFilterFactoryBean.setLoginUrl("/user/loginByPassword");
        ...
        shiroFilterFactoryBean.setUnauthorizedUrl("/user/common/403");
        shiroFilterFactoryBean.setLoginUrl("/user/common/403");
